...
# CONFIG
# =============================
API_BASE = "https://moviemate-bt6y.onrender.com" or "http://127.0.0.1:8000"
...
font-size: 60px;
font-weight: 800;
background: linear-gradient(90deg, #ff4b2b, #ff416c, #7f5af0);
...
""", unsafe_allow_html=True)
st.markdown(
    "<div class='small-muted'>Find movies instantly with smart recommendations.</div>",
    unsafe_allow_html=True,
)
st.divider()
